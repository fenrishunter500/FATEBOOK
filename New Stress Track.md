...
Players start with two Purity stress boxes, and can gain additional boxes in a similar fashion to the Physical and Mental stress tracks with one key difference. At least two of her three Magical skills must be ranked at Average (+1) or Fair (+2) for a single additional stress box. If two of the three are at Good (+3) or higher, she instead receives two additional stress boxes. In addition, if at least one of these skills is at Superb (+5) or higher the Mahou Shoujo will also gain an additional Mild consequence slot, and if all three are ranked Superb (+5) she also gains an additional Moderate consequence slot. These slots are specifically restricted to Purity harm and cannot be used to lessen the impact of a physical or mental hit. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODg1ODg5MTYsODc4MzM3NjA0LC0xMT
